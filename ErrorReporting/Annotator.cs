...
namespace ErrorReporting
{
    ...
    public class Annotator
    {
        ...
        {
            this.ErrorFree = true;
            this.PrintErrorReport = printErrorReport;
        }
        ...
        public void InternalError(InternalErrorCategory category)
        {
            ...
            this.PrintError("Internal", (int)category, message);
        }
        ...
        public void ScopeError(ScopeErrorCategory category)
        {
            ...
            this.PrintError("Scope", (int)category, message);
        }
        ...
        public void KindError(Kind kind, KindErrorCategory category)
        {
            ...
            if (kind != Kind.Undefined)
            {
                ...
                this.PrintError("Kind", (int)category, message);
            }
        }
        ...
        public void TypeError(Type type, TypeErrorCategory category)
        {
            ...
            if (type != Type.Universal)
            {
                ...
                this.PrintError("Type", (int)category, message);
            }
        }
        ...
        {
            if (this.PrintErrorReport != null)
            {
                this.PrintErrorReport(errorCategory, errorCode, errorMessage);
            }
        }
    }
}